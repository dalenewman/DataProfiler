        ...
        static void Main(string[] args) {
            ...
            if (args.Length > 0 && CommandLine.Parser.Default.ParseArguments(args, options)) {
                ...
                using (var scope = new AutofacBootstrapper(connection)) {
                    ...
                    System.Console.WriteLine("Name,Type,Position,Count,Min Value,Max Value,Min Length,Max Length");
                    foreach (var field in profile) {
                        System.Console.WriteLine($"{field.Field.Name},{field.Field.Type},{field.Field.Index},{field.Count},\"{field.MinValue}\",\"{field.MaxValue}\",{field.MinLength},{field.MaxLength}");
                    };
                }
