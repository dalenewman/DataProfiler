    ...
    public static class TransformFactory {
        ...
        static ITransform SwitchTransform(IComponentContext ctx, IContext context) {
            ...
            switch (context.Operation.Method) {
                ...
                case "next": return new NextDayTransform(context);
                ...
                case "include": return new FilterTransform(FilterType.Include, context);
                case "exclude": return new FilterTransform(FilterType.Exclude, context);

                case "fromsplit": return new FromSplitTransform(context);
                case "fromlengths": return new FromLengthsTransform(context);
